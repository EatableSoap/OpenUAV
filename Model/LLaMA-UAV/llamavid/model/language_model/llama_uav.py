...
"""
class LlamaUAVModel(LlamaModel):
    def __init__(self, config):
        # copy from LlamaModel
        super(LlamaUAVModel, self).__init__(config)
    
    ### TODO: rewrite forward function
...
class LlamaUAVForCausalLM(LlamaForCausalLM):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(self, config):
        super().__init__(config)
        self.model = LlamaUAVModel(config)
